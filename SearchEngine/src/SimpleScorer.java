...
final class SimpleScorer extends Scorer {
     ...
     * @param similarity The </code>Similarity</code> implementation to be used for
     *                   score computations.
     * @param norms      The field norms of the document fields for the
     *                   <code>Term</code>.
     */
    SimpleScorer(Weight weight, TermDocs td, Similarity similarity,
                 byte[] norms, float idfValue, float avg,IndexReader reader) {
...
//        if (doc == 25223 || doc == 77432) {
//            System.out.println("doc = " + doc + "   TF = " + tf + "   IDF = " + idf);
//        }
...
//        Document d = null;
//        try {
//            d = reader.document(doc);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        float PR = Float.valueOf(d.get("PR"));
        return (K1 + 1) * tf * idf / (K1 * (1 - b + b * l / avgLength) + tf);
